    ...
    return (
        <div className="space-y-6 pb-10 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-card/50 p-6 rounded-2xl shadow-sm border backdrop-blur-sm">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Tasks</h1>
                    <p className="text-muted-foreground mt-1">Manage project tasks, assignments, and workflows.</p>
                </div>
                <div className="flex items-center gap-2">
                    <Button variant="outline" size="icon" onClick={() => setRefreshTrigger(p => p + 1)}><RefreshCw className="h-4 w-4"/></Button>
                    <Button onClick={handleCreate} className="bg-gradient-to-r from-blue-600 to-indigo-600"><Plus className="mr-2 h-4 w-4"/> New Task</Button>
                </div>
            </div>
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
                <div className="flex justify-between items-center flex-wrap gap-4">
                    <TabsList className="bg-muted/50 p-1">
                        ...
                        <TabsTrigger value="list" className="gap-2"><ListTodo className="h-4 w-4"/> Tasks List</TabsTrigger>
