        ...
        <div className="min-h-screen bg-background pb-20 relative overflow-hidden">
            ...
            <div className="bg-gradient-to-b from-muted/30 to-background border-b border-border/50 py-16 relative z-10">
                <div className="container">
                    <Breadcrumbs items={[{ title: "Legal" }, { title: "Privacy Policy", to: "/legal/privacy" }]} className="mb-6 inline-flex bg-background/60 backdrop-blur-md px-4 py-2 rounded-full border border-border/50 shadow-sm" />
                    <h1 className="text-5xl font-extrabold tracking-tight mb-4 text-foreground">{page?.title || "Privacy Policy"}</h1>
                ...
                <div className="lg:col-span-3">
                    <div className="bg-background/60 backdrop-blur-2xl border border-border/50 rounded-[2.5rem] shadow-lg p-8 md:p-12 overflow-hidden relative">
                        ...
                        <div 
                            ...
                            dangerouslySetInnerHTML={{ __html: page?.content || "<p className='text-lg'>Our privacy policy is currently being updated. Please check back later.</p>" }} 
                        />
                    </div>
