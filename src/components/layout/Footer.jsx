...
import { 
  ...
  Link as LinkIcon, Heart, Wrench, RotateCcw
} from 'lucide-react';
...
const Footer = () => {
  ...
  useEffect(() => {
    ...
    const checkVisibility = async () => {
        // Checking visibility based on typical slug conventions
  ...
  return (
    <footer className="w-full bg-white text-gray-700 border-t border-gray-200 !text-left pb-[80px] md:pb-0 pt-6">
      {shouldShowAds && (
        <AdSenseContainer className="mt-0 mb-8 max-w-7xl mx-auto px-4">
          <AdSenseHorizontal slot="footer_top" />
        </AdSenseContainer>
      )}

      <div className="w-full content-container py-8 md:py-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          {/* Popular Deals */}
          <div className="flex flex-col !items-start !text-left">
             <Link to="/popular-deals" className="group">
      ...
      <div className="border-t border-gray-100 bg-gray-50 w-full">
         <div className="w-full content-container py-4 flex flex-col md:flex-row justify-between !items-start md:!items-center gap-4">
